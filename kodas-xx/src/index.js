...
import AddNewLaiskasContainer from './components/Laisku administravimas/AddNewLaiskasContainer';
...
ReactDOM.render(
    <BrowserRouter>
        ...
        <Route exact path="/laiskai/add" component={AddNewLaiskasContainer} />
    </BrowserRouter>
